 ...
 *
 * Disassembly of iASLyuZTB0.aml, Sat Mar  4 21:50:25 2017
 *
 *
 ...
 */
DefinitionBlock ("iASLyuZTB0.aml", "DSDT", 1, "LENOVO", "TP-G2   ", 0x00002670)
{
    External (PDC7)
    External (PDC6)
    External (PDC5)
    ...
    Scope (\_SB)
    {
        ...
        Device (PCI0)
        {
            ...
            CreateWordField (_CRS, \_SB.PCI0._Y25._MAX, B0MX)
            CreateWordField (_CRS, \_SB.PCI0._Y25._LEN, B0LN)
                                    ...
                                    }), 0x01))
                        {
                            ...
                            If (LEqual (Arg2, 0x02))
                            {
                                If (TPRS)
                                {
                                    ...
                                    If (LAnd (LGreaterEqual (DerefOf (Index (Arg3, 0x00)), 0x0E), 
                                        LLessEqual (DerefOf (Index (Arg3, 0x00)), 0x12)))
                                    {
                                        Store (DerefOf (Index (Arg3, 0x00)), SMID)
                                        Store (0xC1, SMIT)
                                        Store (DerefOf (Index (Arg3, 0x00)), TPP1)
                                    ...
                                    If (LOr (LEqual (DerefOf (Index (Arg3, 0x00)), 0x15), LEqual (
                                        DerefOf (Index (Arg3, 0x00)), 0x16)))
                                    {
                                        Store (DerefOf (Index (Arg3, 0x00)), SMID)
                                        Store (0xC1, SMIT)
                                        Store (DerefOf (Index (Arg3, 0x00)), TPP1)
                            ...
                            If (LEqual (Arg2, 0x05))
                            {
                                ...
                                If (LOr (LOr (LGreater (\_SB.PPLO, 0x16), LEqual (\_SB.PPLO, 0x0C)), LEqual (
                                    \_SB.PPLO, 0x0D)))
                                {
                            ...
                            If (LEqual (Arg2, 0x08))
                            {
                                ...
                                If (LAnd (LGreaterEqual (DerefOf (Index (Arg3, 0x00)), 0x01), 
                                    LLessEqual (DerefOf (Index (Arg3, 0x00)), 0x04)))
                                {
                                ...
                                If (LAnd (LGreaterEqual (DerefOf (Index (Arg3, 0x00)), 0x06), 
                                    LLessEqual (DerefOf (Index (Arg3, 0x00)), 0x0B)))
                                {
                                    If (LGreater (PPIP, 0x00))
                                    {
                                        Return (0x04)
                                ...
                                If (LOr (LEqual (DerefOf (Index (Arg3, 0x00)), 0x0E), LAnd (
                                    LGreaterEqual (DerefOf (Index (Arg3, 0x00)), 0x15), LLessEqual (DerefOf (
                                    Index (Arg3, 0x00)), 0x16))))
                                {
                                ...
                                If (LOr (LEqual (DerefOf (Index (Arg3, 0x00)), 0x10), LEqual (
                                    DerefOf (Index (Arg3, 0x00)), 0x12)))
                                {
                                    Return (0x03)
                                }

                                If (LOr (LEqual (DerefOf (Index (Arg3, 0x00)), 0x00), LOr (
                                    LEqual (DerefOf (Index (Arg3, 0x00)), 0x0F), LEqual (DerefOf (Index (Arg3, 
                                    0x00)), 0x11))))
                                {
                                    Return (0x04)
                                }
                    ...
                    Method (NBCI, 4, NotSerialized)
                    {
                        ...
                        Else
                        {
                            If (LEqual (_T_0, 0x14))
                            {
                                ...
                                {
                                    Store (DerefOf (Index (DerefOf (Index (\_SB.PCI0.LPC.EC.BRTD, \BRTN)), Local1)), 
                                        Local2)
            ...
            Device (XHCI)
            {
                ...
                Method (POSC, 3, Serialized)
                {
                    ...
                    If (LAnd (LNot (And (CDW1, 0x01)), LOr (LEqual (\XHCM, 
        ...
        Device (WMI1)
        {
            ...
            Method (GITM, 2, NotSerialized)
            {
                ...
                {
                    Store (DerefOf (Index (DerefOf (Index (Arg1, Local0)), 0x01)), 
                        Local3)
